...
The shell is a 3-pane UI: bots on the left (personas as teammates), a centered near-black chat in the middle, and a live Computer pane on the right for the per-persona Docker VM plus sandbox exec. No cloud, no Electron, no Google Fonts.
